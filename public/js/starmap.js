...
(function () {
  ...
  const QUADRANTS = {
    '技术':   { center: -45,  color: '#7048c2', glow: 'rgba(112,72,194,.6)' },     // 淡紫云雾
    '人文':   { center: -135, color: '#6038b8', glow: 'rgba(96,56,184,.6)' },      // 亮紫星云
    '科幻':   { center: 135,  color: '#382878', glow: 'rgba(56,40,120,.68)' },     // 中层紫雾
